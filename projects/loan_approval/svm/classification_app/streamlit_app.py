...
def load_pipeline():
    ...
    candidate_paths = [
        Path("../models/svm_loan_approval_pipeline.pkl"),
        Path("models/svm_loan_approval_pipeline.pkl"),
        Path(__file__).resolve().parent.parent /
        "models/svm_loan_approval_pipeline.pkl",
    ]
    ...
    if pipeline_path is None:
        raise FileNotFoundError(
            "Cannot find svm_loan_approval_pipeline.pkl"
        )
...
using the trained Support Vector Machine (SVM) classification model.
"""
)
