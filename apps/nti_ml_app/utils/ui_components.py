...
def render_sidebar():
    ...
    st.sidebar.markdown("### NTI-ML Dashboard")
    st.sidebar.markdown("Navigate the machine learning models trained across the NTI portfolio.")
    st.sidebar.markdown("---")
    ...
    <div class="sidebar-footer">
        ...
        <i>NTI Machine Learning Project</i>
    </div>
    """, unsafe_allow_html=True)

def render_header(title: str, description: str, badge_text: str = "AI Model"):
...
def render_about_section():
    ...
    st.markdown("""
    This application is part of the **NTI Machine Learning Portfolio**. It demonstrates end-to-end machine learning pipelines, from data preprocessing and exploratory data analysis to model training, evaluation, and deployment using Streamlit.
    ...
    *Developed by Ahmed Sameh Mohamed Zaky.*
    ...
    > **Disclaimer:** This application is built for educational and demonstration purposes. Predictions should not be used for absolute real-world financial or HR decisions without human oversight.
    """)
